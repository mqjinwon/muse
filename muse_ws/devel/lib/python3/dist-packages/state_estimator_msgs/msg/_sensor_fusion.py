...
"""autogenerated by genpy from state_estimator_msgs/sensor_fusion.msg. Do not edit."""
import codecs
import sys
...
class sensor_fusion(genpy.Message):
  _md5sum = "971096c93fdd3d0854784d51bb392049"
  _type = "state_estimator_msgs/sensor_fusion"
...
string frame_id
"""
  __slots__ = ['header','position','linear_velocity']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,position,linear_velocity
    ...
    """
    if args or kwds:
      super(sensor_fusion, self).__init__(*args, **kwds)
